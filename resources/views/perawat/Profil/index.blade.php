            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col-md">
                        ...
                        <p class="profile-role">{{ $perawat->pendidikan }}</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-12">
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <div class="info-value">{{ $perawat->no_hp }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <div class="info-value">{{ $perawat->pendidikan }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="info-card-body">
                        <div class="info-item">
                            ...
                            <div class="info-content">
                                ...
                                <div class="info-value">{{ $perawat->alamat }}</div>
                            </div>
                        </div>
                    </div>
                </div>
