    ...
    <div class="container">
        ...
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="header-content">
                ...
                <p>Kelola pengelompokan klinis (Contoh: Terapi, Tindakan)</p>
            </div>
                ...
                <table class="table table-custom">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>
                                <span class="kategori-name">{{ $item->nama_kategori_klinis }}</span>
                            </td>
                        ...
                        <tr>
                            <td colspan="3">
                                <div class="empty-state">
                                    ...
                                    <p class="mb-0">Belum ada data kategori klinis</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
            ...
            <form action="{{ route('Admin.KategoriKlinis.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_kategori_klinis" placeholder="Contoh: Terapi, Tindakan" required>
                    </div>
                </div>
